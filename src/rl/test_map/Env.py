...
class environment():
    def __init__(self):
        ...
        Map 1
        """
        self.x_y = [[0, 0], [-1, 0], [-1, 1], [-1, 2], [0, 2], [0, 1], [0, 0], [1, 0], [1, 1], [1, 2], [-2, 0]]
        """
        Map 2
        """
        # self.x_y = [[0, 0], [-1, 0], [-1, 1], [-1, 2], [0, 2], [0, 1], [0, 0], [1, 0], [1, 1], [1, 2], [-2, 0]]
        ...
        Map 3
        """
        # self.x_y = [[4, 0], [0, 0], [-1, 1], [2, -2], [3, 0], [4, 0], [0, 0], [-1, 1], [2, -2], [3, 0], [4, 0], [0, 0],
        #             [-1, 1],
        #             [2, -2], [3, 0], [4, 0], [0, 0], [-1, 1], [2, -2], [3, 0]]
    ...
    def set_reward(self, action):
        ...
        map_1 test reward
        """
        # reward = (1 / finish_distance) + angle_reward
        """
        map_2 test reward
        """
